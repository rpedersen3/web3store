...
import "./IERC721CatalogExtension.sol";
import "./ERC6059.sol";
abstract contract ERC721CatalogExtension is ERC721, Ownable, ERC6059, IERC721CollectionMetadata, ERC721CollectionMetadata, ERC721URIStorage, IERC721CatalogExtension {

    bytes4 private constant _INTERFACE_ID_ERC721CatalogExtension = 0xbcc08bd3;
...
*/
    ...
    function transferFrom(
        ...
        address to,
        uint256 tokenId
    ) public virtual override (ERC721, IERC721, ERC6059)  {
        super.transferFrom(from, to, tokenId);
    }

    function setApprovalForAll(address operator, bool approved) public virtual 
        override (ERC721, IERC721, ERC6059) {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721, ERC6059, ERC721URIStorage) returns (bool) {
        return
                ...
                interfaceId == type(ERC721CatalogExtension).interfaceId ||
