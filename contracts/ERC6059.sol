...
*/
    ...
    function nestTransferFrom(
        ...
        bytes memory data
    ) public virtual override (IERC6059) onlyApprovedOrDirectOwner(tokenId) {
        //console.log("nestTransferFrom ...");
        //console.log(string.concat("token id: ", from));
    ...
    function _nestTransfer(
        ...
        //console.log(string.concat("parent: ", Strings.toString(parentId)));
...
*/
    ...
    function ownerOf(
        uint256 tokenId
    ) public view virtual override(IERC6059, ERC721) returns (address) {
    ...
    function directOwnerOf(
        uint256 tokenId
    ) public view virtual  override (IERC6059) returns (address, uint256, bool) {
     ...
     */
     /*
    function burn(uint256 tokenId) public virtual override (IERC6059) {
        burn(tokenId, 0);
    }
    */
    ...
    ) public virtual override (IERC6059) onlyApprovedOrDirectOwner(tokenId) returns (uint256) {
    ...
    function addChild(
        ...
        uint256 childId,
        bytes memory data
    ) public virtual override (IERC6059) {
    ...
    function acceptChild(
        ...
        uint256 childId
    ) public virtual override (IERC6059) onlyApprovedOrOwner(parentId) {
     ...
     */
    function rejectAllChildren(uint256 tokenId, uint256 maxRejections) public virtual override (IERC6059) onlyApprovedOrOwner(tokenId) {
    ...
    function transferChild(
        ...
        bool isPending,
        bytes memory data
    ) public virtual  override (IERC6059) onlyApprovedOrOwner(tokenId) {
        _transferChild(
            tokenId,
            to,
            destinationId,
...
*/
    ...
    function _transferChild(
        ...
        //console.log("*********** _transferChild");
        Child memory child;
        if (isPending) {
            child = pendingChildOf(tokenId, childIndex);
        } else {
            //console.log(string.concat("********** childOf: parentId = ", Strings.toString(tokenId)));
            //console.log(string.concat("; index = ", Strings.toString(childIndex)));
            child = childOf(tokenId, childIndex);
        }

        //console.log("*************** _checkExpectedChild");
        _checkExpectedChild(child, childAddress, childId);

        //console.log("_beforeTransferChild");
        ...
        //console.log("_removeChildByIndex");
        if (isPending) {
        ...
        //console.log("_afterTransferChild");
        _afterTransferChild(
            tokenId,
            childIndex,
            childAddress,
    ...
    function childrenOf(
        uint256 parentId
    ) public view virtual override (IERC6059) returns (Child[] memory) {
        Child[] memory children = _activeChildren[parentId];

        //console.log(string.concat("************ children of count: parentId = ", Strings.toString(parentId)));
        //console.log(string.concat("; length = ", Strings.toString(children.length)));
    ...
    function childOf(
        ...
        //console.log(string.concat("************ childOf: parentId = ", Strings.toString(parentId)));
        //console.log(string.concat("; index = ", Strings.toString(index)));
